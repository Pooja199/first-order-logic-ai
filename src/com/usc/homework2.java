...
/***
 *
 * String[] literalParameters = literal.substring(literal.indexOf('(') + 1, literal.indexOf(')')).split(",");
 * //                                    for (int l = 0; l < literalParameters.length; l++) {
 * //                                        if (variableConstantMapping.containsKey(literalParameters[l])) {
 * //                                            literalParameters[l] = variableConstantMapping.get(literalParameters[l]);
 * //                                        }
 * //                                    }
 */
public class homework2 {
    ...
    private static HashMap<String, ArrayList<String>> storekbhmap = new HashMap<String, ArrayList<String>>();
